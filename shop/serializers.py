...
class AdminUserSerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomUser
        fields = ['id', 'username', 'email', 'first_name', 'last_name', 'is_active', 'is_staff', 'date_joined', 'roles']
...
class AdminProductSerializer(serializers.ModelSerializer):
    ...
    def get_thumbnail_images(self, obj):
        ...
        return [
            request.build_absolute_uri(img)
            for img in obj.thumbnail_images
        ]
...
class AdminOrderSerializer(serializers.ModelSerializer):
    ...
    payment = PaymentSerializers(read_only=True)
